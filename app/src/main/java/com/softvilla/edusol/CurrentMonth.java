...
public class CurrentMonth extends Fragment implements OnChartValueSelectedListener {
    ...
    public static final String CURRENTMONTH_URL = "http://ccsanghar.edu.pk/edusolutions/Api/getCurrentMonthAttendance";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        AndroidNetworking.post(preferences.getString("url","") + "getCurrentMonthAttendance")
